...
var GestureElement = class extends s {
  constructor() {
    super();
  ...
  static get styles() {
    return [
      i`:host{display:block;contain:content;z-index:0;opacity:0;visibility:hidden;pointer-events:none!important}:host([hidden]){display:none}`
    ];
  }
  get _pendingActions() {
  ...
  get _pendingAction() {
    var _a;
    return (_a = this._pendingActions) == null ? void 0 : _a.get(this);
  }
  connectedCallback() {
  ...
  disconnectedCallback() {
    ...
    (_a = this._pendingAction) == null ? void 0 : _a[1].resolve();
    (_b = this._pendingActions) == null ? void 0 : _b.delete(this);
  ...
  _attachListener() {
    ...
    const resolve = (skip = false) => {
      count += 1;
      (typeof window !== "undefined" ? window : null)?.clearTimeout(timeoutId);
      timeoutId = (typeof window !== "undefined" ? window : null)?.setTimeout(() => {
        var _a, _b;
        const promise = (_a = this._pendingAction) == null ? void 0 : _a[1];
        if (skip) {
          (_b = this._pendingActions) == null ? void 0 : _b.delete(this);
        }
    ...
    const off = listen(this._mediaProviderElement, this.type, (event) => {
      ...
      if (count == 0) {
        (_a = this._pendingActions) == null ? void 0 : _a.set(this, [event, deferredPromise()]);
      }
  ...
  _subscribeToSeekStore() {
    var _a;
    if (!((_a = this.action) == null ? void 0 : _a.startsWith("seek")))
      return;
  ...
  _getToggleEventType() {
    var _a;
    const toggleType = (_a = this.action) == null ? void 0 : _a.split(":")[1];
    switch (toggleType) {
      case "paused":
  ...
  _subscribeToToggleStore() {
    var _a, _b;
    if (!((_a = this.action) == null ? void 0 : _a.startsWith("toggle:")))
      return;
    const action = this.action.split(":")[1];
    const unsub = (_b = this._mediaStore[action]) == null ? void 0 : _b.subscribe(($value) => {
...
__decorateClass([
  e({ type: Boolean, attribute: "while-idle" })
