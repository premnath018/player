...
var PosterElement = class extends LitElement {
  ...
  static get styles() {
    return [
      css`:host{display:block;contain:content;pointer-events:none;object-fit:cover;box-sizing:border-box}:host([hidden]){display:none}img{display:block;width:100%;height:100%;pointer-events:none;object-fit:inherit;object-position:inherit;user-select:none;-webkit-user-select:none;box-sizing:border-box}`
    ];
  }
  get src() {
    return this.__src;
  ...
  render() {
    return html`<img part="img" src="${ifDefined(this.__canLoad ? this.src : null)}" alt="${ifDefined(this.alt)}" @load="${this._handleImgLoad}" @error="${this._handleImgError}">`;
  }
  _setImgLoadingAttr() {
